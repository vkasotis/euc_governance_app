...
CHANGE_STAGES = ["Proposed", "DEV", "UAT", "PROD", "Post-implementation review", "Emergency fix", "Closed"]
INCIDENT_TYPES = ["Data error", "Calculation / logic error", "Timing delay", "Access / security", "Availability / outage", "Distribution error", "Control failure", "Near miss", "Other"]
INCIDENT_SEVERITIES = ["Low", "Medium", "High", "Critical"]
ROOT_CAUSE_CATEGORIES = ["Data source", "Logic / formula", "Manual process", "Access / permissions", "Dependency / upstream", "Storage / platform", "Documentation / procedure", "SPOF / resourcing", "Other"]
DATA_CLASSIFICATIONS = ["Public", "Internal", "Confidential", "Restricted", "PII / personal data", "Regulatory confidential"]
MIGRATION_STATUSES = ["Not assessed", "Candidate", "In progress", "Migrated", "Decommissioned", "Not applicable"]
...
CREATE_TABLES_SQL = [
    ...
    CREATE TABLE IF NOT EXISTS material_changes (
        ...
        change_stage TEXT,
        testing_required INTEGER NOT NULL DEFAULT 0,
        uat_required INTEGER NOT NULL DEFAULT 0,
        ...
        library_controls_update_required INTEGER NOT NULL DEFAULT 0,
        evidence_pack_update_detail TEXT,
        stakeholder_communication TEXT,
        communication_date TEXT,
        effective_date TEXT,
        emergency_change INTEGER NOT NULL DEFAULT 0,
        retro_uat_required INTEGER NOT NULL DEFAULT 0,
        status TEXT,
        created_by TEXT NOT NULL,
        created_at TEXT NOT NULL,
        FOREIGN KEY (euc_id) REFERENCES eucs(euc_id)
    ...
    """,
    """
    CREATE TABLE IF NOT EXISTS high_criticality_reviews (
        review_id INTEGER PRIMARY KEY AUTOINCREMENT,
        euc_id INTEGER NOT NULL,
        reviewer TEXT NOT NULL,
        review_date TEXT NOT NULL,
        mandatory_flag INTEGER NOT NULL DEFAULT 0,
    ...
    """,
    """
    CREATE TABLE IF NOT EXISTS industrialization_assessments (
        assessment_id INTEGER PRIMARY KEY AUTOINCREMENT,
        euc_id INTEGER NOT NULL,
        bcbs_score INTEGER NOT NULL DEFAULT 0,
        residual_score INTEGER NOT NULL DEFAULT 0,
        operational_score INTEGER NOT NULL DEFAULT 0,
        frequency_volume_score INTEGER NOT NULL DEFAULT 0,
...
INDEX_SQL = [
    ...
    "CREATE INDEX IF NOT EXISTS idx_doc_gaps_euc ON documentation_gaps(euc_id, status);",
    "CREATE INDEX IF NOT EXISTS idx_highcrit_euc ON high_criticality_reviews(euc_id, review_date);",
    "CREATE INDEX IF NOT EXISTS idx_industrialization_euc ON industrialization_assessments(euc_id, assessment_date);",
]
