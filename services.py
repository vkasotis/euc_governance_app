...
ARTIFACT_UPLOAD_GUIDANCE = {
    ...
    "Incident & RCA Evidence": "Incident record plus root-cause analysis, containment, correction, re-issue evidence and corrective/preventive actions with owners and dates.",
...
def artifact_user_action(document_type: str, status: str | None = None) -> str:
    ...
    """
    doc_type = canonical_document_type(document_type) or ""
...
def _extract_artifact_from_task(title: str | None, description: str | None = None) -> str | None:
    ...
    for prefix, suffix in [
        ...
        if prefix in text:
            ...
            canonical = canonical_document_type(candidate)
            if canonical and (canonical in ARTIFACT_UPLOAD_GUIDANCE or canonical == "Risk Assessment"):
                return canonical
